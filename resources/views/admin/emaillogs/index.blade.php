										...
										<div>
											<div class="row mb-6">
												<div class="col-lg-3 mb-lg-0 mb-6">
													<label>{{trans("messages.admin_common_Email")}}</label>
													<input type="text" class="form-control" name="email_to" placeholder="{{trans("messages.admin_common_Email_From")}}" value="{{$searchVariable->email_to ?? ''}}">
												</div>
												<div class="col-lg-3 mb-lg-5 mb-6">
													<label>{{trans("messages.admin_common_Mail_Subject")}}</label>
													<input type="text" class="form-control" name="subject" placeholder="{{trans("messages.admin_common_Mail_Subject")}}" value="{{$searchVariable->subject ?? ''}}">
												</div>
												<div class="col-lg-3 mb-lg-5 mb-6">
										...
										<table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
											<thead>
												<tr class="text-uppercase">
													...
													$query_string))}}">{{trans("messages.admin_common_Email_To")}}</a>
													</th>
													...
													$query_string))}}">{{trans("messages.admin_common_Email_From")}}</a>
													</th>
													...
													$query_string))}}">{{trans("messages.admin_common_Subject")}}</a>
													</th>
													...
													$query_string))}}">{{trans("messages.admin_common_Mail_Sent_On")}}</a>
													</th>
											...
											<tbody>
												...
												<tr>
													...
													<td class="text-right pr-2">
														<a href='javascript:void(0);' class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="{{trans('messages.admin_common_View')}}" onclick="getPopupClient(<?php echo $data->id; ?>)">
