		...
		<div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					{{trans("messages.admin_common_Email_Templates")}}
					</h5>
									...
									<div id="collapseOne6" class="collapse <?php echo !empty($searchVariable) ? 'show' : ''; ?>" data-parent="#accordionExample6">
										<div>
											<div class="row mb-6">
												...
												<div class="col-lg-3 mb-lg-5 mb-6">
													<label>{{trans("messages.admin_common_Subject")}}</label>
													<input type="text" class="form-control" name="subject" placeholder="{{trans("messages.admin_common_Subject")}}" value="{{$searchVariable->subject ?? ''}}">
												</div>
											</div>
											<div class="row mt-8">
												<div class="col-lg-12">
										...
										<table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<input type="checkbox" class="mail_checkbox" data-email-id="{{$result->id}}" name="is_enable" value="1" {{ ($result->mail_enable == 1) ? 'checked' : '' }}>
													</td>
													<td>
														<div class="text-dark-75 mb-1 font-size-lg">
...
<script>
	$(document).ready(function(){
		$(".mail_checkbox").on("change", function(){
			...
			$.ajax({
				url: "{{ route('email-templates.admin-email-template-mail-enable')}}",
				type: "get",
				data:{emailId:emailId, checkedValue:checkedValue},
