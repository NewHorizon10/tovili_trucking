...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
						...
						<li class="breadcrumb-item">
							<a href="{{route('company-subscription-plans.index')}}" class="text-muted">  {{trans("messages.company_subscription_plans")}}
							</a>
						</li>
					</ul>
				</div>
	...
	<div class="d-flex flex-column-fluid">
		<div class=" container ">
				<form action="{{ route('send.tidaluk.companysubscription.plans.notification') }}" id="notification-form" method="post" clas="kt-form kt-form--fit mb-0" autocomplete="off">
				@csrf 
									...
									<div class="table-responsive table-responsive-new">
										<table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
											...
											<tbody>
												...
												<tr>
													<td>
														<input type="checkbox" data-notification-id="{{ $template->NotificationAction?->id }}"
														data-notification-action="{{ $template->NotificationAction->action }}"
														 class="childCheckboxes notification-template-list notification-change" name="notificationAction[]" value="{{ $template->NotificationAction ?->action }}">
													</td>
													<td>
														{{ $template->name ?? '' }}
													</td>
