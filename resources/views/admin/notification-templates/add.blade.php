			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					<h5 class="text-dark font-weight-bold my-1 mr-5">
						Add {{Config('constants.NOTIFICATION_TEMPLATES_TITLE.NOTIFICATION_TEMPLATE')}} 
					</h5>
					<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
						...
						<li class="breadcrumb-item">
							<a href="{{ route($model.'.index')}}" class="text-muted">{{Config('constants.NOTIFICATION_TEMPLATES_TITLE.NOTIFICATION_TEMPLATES')}}</a>
						</li>
					</ul>
				</div>
			</div>
					...
					<div class="card-body">
												...
												<div class="row">
													...
													<div class="col-xl-6">
														<div class="form-group">
															@if($i == 1)
																...
																<select name="data[{{$language->id}}][action]" id="action" class="form-control select2init @error('action') is-invalid @enderror">
															...
															@else
																<lable for="action">Action</lable><span class="text-danger"> </span>
																<select name="data[{{$language->id}}][action]" id="action" class="form-control select2init">
																	<option value="">Select Action</option>
																	@foreach($Action_options as $action)
																		<option value="{{$action->action}}">{{$action->action}}</option>
																	@endforeach
													...
													<div class="col-xl-6">
														<div class="form-group">
															...
															<select name="constants" id="constants" class="form-control select2init"></select>
													...
													<div class="col-xl-12">
														...
														<div class="form-group">
															...
															@if($i == 1)
																...
																<textarea id="body_{{$language->id}}" name="data[{{$language->id}}][body]" class="form-control form-control-solid form-control-lg  @error('body') is-invalid @enderror" value="{{old('body')}}"></textarea>
																@if ($errors->has('body'))
																	<div class="invalid-feedback">
																		{{ $errors->first	('body') }}
																	</div>
															...
															@else
																<lable for="{{$language->id}}.'.body'">Email Body </lable><span class="text-danger"> </span>
																<textarea id="body_{{$language->id}}" name="data[{{$language->id}}][body]" class="form-control form-control-solid form-control-lg " value="{{old('body')}}"></textarea>
															@endif
														</div>
						...
						<div class="d-flex justify-content-between border-top mt-5 pt-10">
							<div class="row">
								...
								<div class="col-6">
									<a type="button" href="{{ route('notification-templates.index')}}" class="btn btn-danger font-weight-bold text-uppercase px-9 py-4">
...
<script type='text/javascript'>
	...
	/* this function used for get constant,define in notification template*/
	$('#action').change(function() {
		...
		$.ajax({
			...
			url: "<?php echo URL()->to('adminpnlx/notification-templates/get-constant') ?>",
			type: "POST",
			data: {
				constant: constant
			},
