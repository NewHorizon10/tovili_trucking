...
*/
	...
	*/
	public function saveDepartment(){
		...
		if(!empty($formData)){
			...
			if ($validator->fails()){
				...
				$Department->dealer_id   		= Auth::user()->id;
				...
				return Redirect::to('/dealerpanel/dealer-staff-department');
	...
	public function editDepartment($id = ""){
		...
		return View::make('dealerpanel.'.$this->model.'.edit', compact("departmentDetails",'designationsDetails'));
