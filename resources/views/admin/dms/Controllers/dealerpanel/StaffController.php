...
*/
	...
	public function listStaff(){
		...
		$result 				= 	$DB
									...
									->where('users.user_role_id',STAFF_USER_ROLE_ID)
		...
		return  View::make('dealerpanel.'.$this->model.'.index', compact('result','searchVariable','sortBy','order','query_string','designations','dealerLocationCode','dealerLocationName'));
	}
	...
	*/
	...
	public function addStaff(){
		...
		return View::make('dealerpanel.'.$this->model.'.add', compact( 'departments','training_attended','dealerLocationName','qualification','stateList','aclModules'));
		}
	...
	*/
	public function saveStaff(){
		...
		if(!empty($formData)){
			...
			if ($validator->fails()){
				...
				$dealer_id				=	$this->get_dealer_id();
				$staff 								= 	new User;
				$staff->dealer_id					=	$dealer_id;
				$staff->user_role_id				=	STAFF_USER_ROLE_ID;
				...
				$staff->dealer_location_name		=	Input::get('dealer_location_name');
				...
				return Redirect::to('/dealerpanel/staff-management');
	...
	public function editStaff($id = ""){
		...
		return View::make('dealerpanel.'.$this->model.'.edit', compact("staffDetails",'cityList','stateList','dealerLocationName','qualification','departments','designations','aclModules'));
	...
	$staffDetails	    =	DB::table('users')
		...
		if(empty($staffDetails)) {
			...
			return View::make('dealerpanel.'.$this->model.'.view', compact('staffDetails'));
		}
	}
