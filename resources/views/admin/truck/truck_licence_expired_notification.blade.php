...
<script src="{{ asset('/public/js/ckeditor/ckeditor.js') }}"></script>
    <div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('truck.license.index') }}"
                                    class="text-muted">{{ trans('messages.Truck License List') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="d-flex flex-column-fluid">
            <div class=" container ">
                    <form action="{{ route('send-licence-expire-notification') }}" id="notification-form" method="post" clas="kt-form kt-form--fit mb-0" autocomplete="off">
                    @csrf
                                                    ...
                                                    <tr>
                                                        <th>
                                                            <input type="checkbox" id="allCheckboxes"
                                                                class="allCheckboxes notification-change">
                                                        </th>
