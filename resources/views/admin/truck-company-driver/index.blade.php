            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        {{trans("messages.admin_common_Drivers")}}
                    </h5>
                    ...
                    <div class="card card-custom card-stretch card-shadowless">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                ...
                                <a href='{{route("$model.create",($TCuserid? ["truck_id=".$TCuserid] :null))}}' class="btn btn-primary mr-2">
                                    {{trans("messages.admin_common_Add_New")}} {{trans("messages.admin_common_Driver")}}
                                </a>
                                <a href='{{route("$model.export",($TCuserid? ["truck_id=".$TCuserid] :null))}}' class="btn btn-primary">
                                ...
                                <div id="collapseOne6" class="collapse <?php echo !empty($searchVariable) ? 'show' : ''; ?>" data-parent="#accordionExample6">
                                    <div>
                                       ...
                                       <label>{{trans("messages.location")}}</label>
                                        <input type="text" name="company_city" id="company_city"  class="form-control 1-form-fields" data-is-required="1"
                                            placeholder="{{ trans('messages.pickup_city') }}" aria-describedby="pickup_city">
                        ...
                        <div class="dataTables_wrapper ">
                                    ...
                                    <thead>
                                        <tr class="text-uppercase">
                                            <th class="{{(($sortBy == 'system_id' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'system_id' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                <a href="{{route($model.'.index',array(	'sortBy' => 'system_id','order' => ($sortBy == 'system_id' && $order == 'desc') ? 'asc' : 'desc',	
                                            ...
                                            <th class="{{(($sortBy == 'name' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'name' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                <a href="{{route($model.'.index',array(	'sortBy' => 'name','order' => ($sortBy == 'name' && $order == 'desc') ? 'asc' : 'desc',	
                                                   $query_string))}}">{{trans("messages.name")}}
                                                </a>
                                            </th>
                                            <th class="{{(($sortBy == 'phone_number' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'phone_number' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                <a href="{{route($model.'.index',array(	'sortBy' => 'phone_number','order' => ($sortBy == 'phone_number' && $order == 'desc') ? 'asc' : 'desc',	
                                                   $query_string))}}"> {{ trans("messages.Phone Number") }}</a>
                                            </th>
                                            <th class="{{(($sortBy == 'last_activity_date_time' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'last_activity_date_time' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                <a href="{{route($model.'.index',array(	'sortBy' => 'last_activity_date_time',
                                                   'order' => ($sortBy == 'last_activity_date_time' && $order == 'desc') ? 'asc' : 'desc',	
                                                   $query_string))}}">{{trans("messages.admin_app_status")}}</a>
                                            </th>
                                            ...
                                            <th class="{{(($sortBy == 'is_active' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'is_active' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                <a href="{{route($model.'.index',array(	'sortBy' => 'is_active',
                                                        ...
                                                        $query_string))}}">{{trans("messages.admin_common_Status")}}
                            ...
                            <td class="text-right pr-2">
                                ...
                                @endif
                                <a href="{{route($model.'.edit',array(base64_encode($result->id),($TCuserid?  "truck_id=".$TCuserid : null)))}}" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="{{trans('messages.admin_common_Edit')}}">
                                ...
                                <a href="{{route($model.'.show',array(base64_encode($result->id),($TCuserid? "truck_id=".$TCuserid : null)))}}" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="{{trans('messages.admin_common_View')}}">
                                    <span class="svg-icon svg-icon-md svg-icon-primary">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24" />
