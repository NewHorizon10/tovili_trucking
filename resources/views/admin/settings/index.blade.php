			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					<h5 class="text-dark font-weight-bold my-1 mr-5">
						{{Config('constants.SETTING.SETTINGS_TITLE')}}
					</h5>
						...
						<div class="card card-custom card-stretch card-shadowless">
							<div class="card-header">
								...
								<div class="card-toolbar">
									...
									<a href="{{route($model.'.create')}}" class="btn btn-primary"> {{ 'Add New ' }}{{Config('constants.SETTING.SETTING_TITLE')}} </a>
								</div>
							</div>
							<div class="card-body">
											...
											<thead>
												...
												<tr class="text-uppercase">
													...
													<th class="{{(($sortBy == 'key' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'key' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
														<a href="{{route($model.'.index',array(	'sortBy' => 'key',
													...
													<th class="{{(($sortBy == 'value' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'value' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
														<a href="{{route($model.'.index',array(	'sortBy' => 'value',
											...
											<tbody>
												...
												<tr>
													...
													<td class="text-right pr-2">
														<a href="{{route($model.'.edit',base64_encode($record->id))}}" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="Edit">
														...
														<a href="{{route($model.'.delete',base64_encode($record->id))}}" class="btn btn-icon btn-light btn-hover-danger btn-sm confirmDelete" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="Delete">
