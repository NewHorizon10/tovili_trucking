						...
						<div class="row">
							...
							<div class="col-xl-10">
										...
										foreach ($result as $setting) {
											...
											switch ($inputType) {
												case 'checkbox': ?>
													<div class="col-xl-6">
														<div class="form-group">
															<label style="width:300px;">{{trans('messages.'. $label)}}</label>
												...
												case 'text': ?>
													<div class="col-xl-6">
														<div class="form-group">
															<label>{{trans('messages.'. $label)}}</label>
												...
												case 'select': ?>
													<div class="col-xl-6">
														<div class="form-group">
															<label>{{trans('messages.'. $label)}}</label>
															<select name="Setting[{{$i}}]['value']" class="form-control select2init" id="{{$key}}">
								...
								<div class="d-flex justify-content-between border-top mt-5 pt-10">
									<div class="row">
										<div class="col-6">
											<input type="button" onclick="submit_form();" value="{{ trans('messages.submit') }}" class="btn btn-success font-weight-bold text-uppercase px-9 py-4">
										</div>
										<div class="col-6">
