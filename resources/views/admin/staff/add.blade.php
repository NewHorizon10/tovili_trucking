        ...
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    {{trans("messages.admin_common_Add_New")}} {{trans("messages.admin_common_Staff")}} </h5>
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item">
                            <a href="{{ route('dashboard')}}" class="text-muted">{{trans("messages.Dashboard")}}</a>
                        </li>
                        <li class="breadcrumb-item">
                            <a href="{{ route($model.'.index')}}" class="text-muted"> {{trans('messages.admin_common_Staff')}}</a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-10">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            <label for="phone_number">{{trans('messages.Password')}}</label><span class="text-danger"> * </span>
                                            <input type="password" name="password" class="form-control form-control-solid form-control-lg  @error('password') is-invalid @enderror" oninput="validatePassword(this);" onpaste="validatePassword(this);" value="{{old('password')}}">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            <label for="phone_number">{{trans('messages.confirm_password')}}</label><span class="text-danger"> * </span>
                                            <input type="password" name="confirm_password" class="form-control form-control-solid form-control-lg  @error('confirm_password') is-invalid @enderror" oninput="validatePassword(this);" onpaste="validatePassword(this);" value="{{old('confirm_password')}}">
                                ...
                                <hr>
                                <h3 class="mb-10 font-weight-bold text-dark">
                                    {{trans('messages.staff_management_department_information')}}</h3>
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <select name="designation_id" id="designation_id" class=" form-control form-control-solid form-control-lg chosenselect_designation_id @error('designation_id') is-invalid @enderror">
                                                <option value="">{{trans('messages.Select')}} {{trans('messages.roles')}}</option>
