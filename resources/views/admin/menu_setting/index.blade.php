...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<div class="d-flex flex-column-fluid">
		<div class=" container ">
			<form action="{{route('menu_setting.index')}}" method="get" class="kt-form kt-form--fit mb-0" autocomplete="off">
									...
									<div class="row mb-6">
											...
											<div class="row mt-8">
												<div class="col-lg-12">
													...
													&nbsp;&nbsp;
													<a href='{{ route("menu_setting.index")}}' class="btn btn-secondary btn-secondary--icon">
														<span>
											...
											<tbody>
												...
												<tr>
													...
													<td class="text-right pr-2">
														<a href="{{route('menu_setting.edit',base64_encode($result->id))}}" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="{{trans("messages.admin_common_Edit")}}">
