...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<div class="d-flex flex-column-fluid">
		<div class=" container ">
			<form action="{{ route($model.'.index_truck',array($entruckid))}}" method="get" clas="kt-form kt-form--fit mb-0" autocomplete="off">
				<div class="row">
					<div class="col-12">
						<div class="card card-custom card-stretch card-shadowless">
							<div class="card-header">
								...
								<div class="card-toolbar">
									...
									<a href='{{route("$model.truck_create",array($entruckid))}}' class="btn btn-primary"> {{trans("messages.admin_Add_new_truck")}} </a>
								</div>
							</div>
							<div class="card-body">
										...
										<div>
											...
											<div class="row mt-8">
												<div class="col-lg-12">
													...
													&nbsp;&nbsp;
													<a href='{{ route($model.'.index_truck',array($entruckid))}}' class="btn btn-secondary btn-secondary--icon">
														<span>
											...
											<tbody>
												...
												<tr>
													...
													<td class="text-right pr-2">
														<a href="{{route($model.'.edit_truck',base64_encode($result->id))}}" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="{{trans("messages.admin_common_Edit")}}">
														...
														<a href="{{route($model.'.delete_truck',base64_encode($result->id))}}" class="btn btn-icon btn-light btn-hover-danger btn-sm confirmDelete" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="{{trans("messages.admin_common_Delete")}}">                            
