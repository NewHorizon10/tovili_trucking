...
?>
    ...
    <div class="d-flex flex-column-fluid">
        <div class=" container ">
            {{ Form::open(['method' => 'get','role' => 'form','route' => "$model.index",'class' => 'kt-form kt-form--fit
                    ...
                    <div class="card card-custom card-stretch card-shadowless">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                ...
                                {{trans("messages.admin_common_Add_New")}} {{trans('messages.admin_Truck_Company')}}
                                </a>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div>
                                        <div class="row mb-6">
                                            <div class="col-lg-3 mb-lg-5 mb-6">
                                                ...
                                                <select name="is_active" class="form-control select2init"
                                                    ...
                                                    <option value="1" {{ isset($searchVariable['is_active']) &&
                                                        $searchVariable['is_active']==1 ? 'selected' : '' }}>{{trans("messages.admin_common_Activate")}}
                                                    </option>
                                                    <option value="0" {{ isset($searchVariable['is_active']) &&
                                                        $searchVariable['is_active']==0 ? 'selected' : '' }}>{{trans("messages.admin_common_Deactivate")}}
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="col-lg-3 mb-lg-5 mb-6">
                                            ...
                                            <div class="col-lg-3 mb-lg-5 mb-6">
                                                ...
                                                <input type="text" class="form-control" name="phone_number"
                                                    placeholder="{{trans('messages.Phone Number')}}"
                                                    value="{{$searchVariable['phone_number'] ?? '' }}"
                                                    oninput="validatePhoneNumber(this);" onpaste="validatePhoneNumber(this);">
                                            </div>
                                            ...
                                            @if(!empty($companyType))
                                               @foreach($companyType as $type)
                                                <option value="{{ $type->id }}" {{ isset($searchVariable['company_type']) && $searchVariable['company_type'] == $type->id ? 'selected': '' }} > {{ $type->code }} </option>
                                               @endforeach
                                            @endif
                                         </select> -->

                                        <div class="col-lg-3 mb-lg-5 mb-6">
                                            <label>{{trans("messages.Company Location")}}</label>
                                            <input type="text" class="form-control" name="company_location"
                                                placeholder="{{trans('messages.Company Location')}}"
                                                value="{{$searchVariable['company_location'] ?? '' }}">
                                        </div>
                                        ...
                                        <div class="col-lg-3 mb-lg-5 mb-6">
                                            ...
                                            <div class="input-group date" id="datepickerfrom"
                                                ...
                                                {{ Form::text('date_from',((isset($searchVariable['date_from'])) ?
                                                $searchVariable['date_from'] : ''), ['class' => ' form-control
                                                datetimepicker-input','placeholder'=>trans("messages.admin_Date_From")
                                        ...
                                        <div class="col-lg-3 mb-lg-5 mb-6">
                                            ...
                                            <div class="input-group date" id="datepickerto" data-target-input="nearest">
                                                {{ Form::text('date_to',((isset($searchVariable['date_to'])) ?
                                                $searchVariable['date_to'] : ''), ['class' => ' form-control
                                                datetimepicker-input','placeholder'=>trans("messages.admin_Date_To")
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <a href='{{ route("$model.index")}}'
                                                ...
                                                <span>
                                                    ...
                                                    <span>{{trans("messages.Clear_Search")}}</span>
                                                </span>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <table
                                    ...
                                    <thead>
                                        <tr class="text-uppercase">
                                            <th
                                                class="{{(($sortBy == 'id' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'id' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                            ...
                                            <th
                                                class="{{(($sortBy == 'phone_number' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'phone_number' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                           ...
                                           <th
                                                ...
                                                <a href="{{route($model.'.index',array(	'sortBy' => 'id',
                                                   'order' => ($sortBy == 'id' && $order == 'desc') ? 'asc' : 'desc',	
                                                   $query_string))}}">{{trans("messages.Company Location")}}</a>
                                            </th>
                                            ...
                                            <th
                                                ...
                                                <a href="{{route($model.'.index',array(	'sortBy' => 'id',
                                                   'order' => ($sortBy == 'id' && $order == 'desc') ? 'asc' : 'desc',	
                                                   $query_string))}}">{{trans("messages.Company Logo")}}</a>
                                            </th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="text-dark-75 mb-1 font-size-lg">
                                                    {{ $result->userCompanyInformation->company_name ?? ''}}
                                                </div>
                                            </td>
                                            ...
                                            <!-- <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">
                                                        @if(!empty($result->userCompanyInformation->company_type))
                                                            @if($result->userCompanyInformation->company_type == 1)
                                                                    Corporation
                                                            @elseif($result->userCompanyInformation->company_type == 2)
                                                                    Partnership
                                                            @else
                                                                    Sole Proprietorship
                                                            @endif
                                            ...
                                            <td>
                                                <div class="text-dark-75 mb-1 font-size-lg">
                                                    {{ $result->userCompanyInformation->company_location ?? ''}}
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="text-dark-75 mb-1 font-size-lg">
                                                    {{ $result->logo ?? '' }}
                                                    @if (!empty($result->userCompanyInformation->company_logo))
                                                    <a class="fancybox-buttons" data-fancybox-group="button"
                                                        href="<?php echo $result->userCompanyInformation->company_logo; ?>">
                                                        <img width="70px" height="50px"
                                                            alt="{{ trans('messages.admin_common_Image') }}"
                                                            src="{{ $result->userCompanyInformation->company_logo }}" />
                                                    </a>
                                                    @endif
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-right pr-2">
                                                ...
                                                <a href="{{route($model.'.index_truck',array(base64_encode($result->id)))}}" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="{{trans('messages.Truck Details')}}">
                                                    ...
                                                    <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Text/Quote2.svg-->
                                        ...
                                        @else
                                        <tr>
                                            <td colspan="6" style="text-align:center;"> {{trans("messages.admin_common_Record_not_found")}}
                                            </td>
                                        </tr>
                                        @endif
                                    </tbody>
