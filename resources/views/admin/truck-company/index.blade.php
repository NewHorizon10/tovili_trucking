                    ...
                    <div class="card card-custom card-stretch card-shadowless">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                ...
                                <a href='{{route("$model.import")}}' class="btn btn-primary mx-2">
                                    {{trans("messages.admin_Import_Truck_Company")}}
                                </a>
                                    ...
                                    <div>
                                        <div class="row mb-6">
                                            <div class="col-lg-3 mb-lg-5 mb-6">
                                                ...
                                                <select name="status" class="form-control select2init" value="{{$searchVariable['status'] ?? ''}}">
                                                    ...
                                                    <option value="active" {{ isset($searchVariable['status']) && $searchVariable['status']=="active" ? 'selected' : '' }}>{{trans("messages.admin_common_Activate")}}</option>
                                                    <option value="deactivate" {{ isset($searchVariable['status']) && $searchVariable['status']=="deactivate" ? 'selected' : '' }}>{{trans("messages.admin_common_Deactivate")}}</option>
                                                    <option value="rejected" {{ isset($searchVariable['status']) && $searchVariable['status']=="rejected" ? 'selected' : '' }}>{{trans("messages.admin_common_rejected")}}</option>
                                                    <option value="waiting_for_approval" {{ isset($searchVariable['status']) && $searchVariable['status']=="waiting_for_approval" ? 'selected' : '' }}>{{trans("messages.admin_common_waiting_for_approval")}}</option>
                                                    <option value="inactive_over_30_days" {{ isset($searchVariable['status']) && $searchVariable['status']=="inactive_over_30_days" ? 'selected' : '' }}>{{trans("messages.inactive_over_30_days")}}</option>
                                                </select>
                                            </div>

                                            <div class="col-lg-3 mb-lg-5 mb-6">
                                                <label>{{trans("messages.admin_plan_status")}}</label>
                                                <select name="plan_status" class="form-control select2init" value="{{$searchVariable['status'] ?? ''}}">
                                                    <option value="">{{trans("messages.admin_All")}}</option>
                                                    <option value="activate" {{ isset($searchVariable['plan_status']) && $searchVariable['plan_status']=="activate" ? 'selected' : '' }}>{{trans("messages.admin_common_Activate")}}</option>
                                                    <option value="deactivate" {{ isset($searchVariable['plan_status']) && $searchVariable['plan_status']=="deactivate" ? 'selected' : '' }}>{{trans("messages.admin_common_Expired")}}</option>
                                                    <option value="no_purchased" {{ isset($searchVariable['plan_status']) && $searchVariable['plan_status']=="no_purchased" ? 'selected' : '' }}>{{trans("messages.no_purchased_plan")}}</option>
                                                    <option value="near_to_expiry_plan" {{ isset($searchVariable['plan_status']) && $searchVariable['plan_status']=="near_to_expiry_plan" ? 'selected' : '' }}>{{trans("messages.near_to_expiry_plan")}}</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-lg-3 mb-lg-5 mb-6">
                                                <label>{{trans('messages.admin_phone_number')}} </label>
                                                <input type="text" class="form-control" name="phone_number"
                                                    placeholder="{{trans('messages.admin_phone_number')}}"
                                        ...
                                        <div class="col-lg-3 mb-lg-5 mb-6">
                                                ...
                                                <input type="text" class="form-control" name="plan_name"
                                                    placeholder="{{trans('messages.admin_plan_name')}}"
                                                    value="{{$searchVariable['plan_name'] ?? '' }}">
                                            </div>
                                    </div>
                                    <div class="row mt-8">
                                        <div class="col-lg-12">
                                ...
                                <table
                                    ...
                                    <thead>
                                        <tr class="text-uppercase">
                                            <th
                                                ...
                                                <a href="{{route($model.'.index',array(	'sortBy' => 'id',
                                            ...
                                            <th
                                                class="{{(($sortBy == 'total_offers' && $order == 'desc') ? '' : (($sortBy == 'total_offers' && $order == 'asc') ? '' : ''))}}">
                                                <a href="{{route($model.'.index',array(	'sortBy' => 'total_offers',
                                                   'order' => ($sortBy == 'total_offers' && $order == 'desc') ? 'asc' : 'desc',	
                                                   $query_string))}}">{{trans("messages.admin_common_offers")}}</a>
                                            </th>

                                            <th
                                                class="{{(($sortBy == 'total_shipments' && $order == 'desc') ? '' : (($sortBy == 'total_shipments' && $order == 'asc') ? '' : ''))}}">
                                                <a href="{{route($model.'.index',array(	'sortBy' => 'total_shipments',
                                                   'order' => ($sortBy == 'total_shipments' && $order == 'desc') ? 'asc' : 'desc',	
                                                   $query_string))}}">{{trans("messages.admin_common_Shipment")}}</a>
                                            </th>

                                            <th
                                                class="{{(($sortBy == 'total_trucks' && $order == 'desc') ? '' : (($sortBy == 'total_trucks' && $order == 'asc') ? '' : ''))}}">
                                                <a href="{{route($model.'.index',array(	'sortBy' => 'total_trucks',
                                                'order' => ($sortBy == 'total_trucks' && $order == 'desc') ? 'asc' : 'desc',	
                                                $query_string))}}">{{trans("messages.admin_total_trucks")}}</a>
                                            </th>

                                            <th class="{{(($sortBy == 'company_refueling' && $order == 'desc') ? '' : (($sortBy == 'company_refueling' && $order == 'asc') ? '' : ''))}}">
                                                <a href="{{route($model.'.index',array( 'sortBy' => 'company_refueling',
                                                'order' => ($sortBy == 'company_refueling' && $order == 'desc') ? 'asc' : 'desc',    
                                                $query_string))}}">
                                                    {{trans("messages.refueling_method")}}
                                                </a>
                                            </th>

                                            <th class="{{(($sortBy == 'company_tidaluk' && $order == 'desc') ? '' : (($sortBy == 'company_tidaluk' && $order == 'asc') ? '' : ''))}}">
                                            ...
                                            <th
                                                class="{{(($sortBy == 'last_activity_date_time' && $order == 'desc') ? '' : (($sortBy == 'last_activity_date_time' && $order == 'asc') ? '' : ''))}}">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <a href="{{route($model.'.index_truck',array(base64_encode($result->id)))}}" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="{{trans('messages.Truck Details')}}">
                                                {{ $result->total_trucks }}
                                                </a>
                                            </td>
                                            <td>
                                                 @foreach($fuelingMethods as $fuelMethods)
                                                  {{($fuelMethods->parent_id == $result->company_refueling) ? $fuelMethods->code : ''}}
                                                 @endforeach
                                            </td>
                                            <td>
                                                @foreach($tidalukCompanies as $tdCompany)
                                                  {{($tdCompany->parent_id == $result->company_tidaluk) ? $tdCompany->code : ''}}
                                                  @endforeach
                                            ...
                                            <td>
                                                <div class="text-dark-75 mb-1 font-size-lg">
                                                   @if($result->planDetails != null && $result->planDetails ?->status != 'pending')
                                                      <!--   @php 
                                                            if ($result->planDetails ?->type == '0') {
                                                                $typeData = trans('messages.monthly');
                                                            } elseif ($result->planDetails ?->type == '1') {
                                                                $typeData = trans('messages.quarterly');
                                                            } elseif ($result->planDetails ?->type == '2') {
                                                                $typeData = trans('messages.Half Yearly');
                                                            } elseif ($result->planDetails ?->type == '3') {
                                                                $typeData = trans('messages.Yearly');
                                                            }
                                                            echo $typeData;
                                                        @endphp -->

                                                        <p class="mb-0" title="{{$result->plan_name}}" data-toggle="tooltip" data-placement="top" data-container="body"
                                                        data-boundary="window">
                                                          {{Str::limit($result->plan_name, 22) ?? ''}}
                                                        </p>
                                                        
                                                        @if($result->planDetails ?->status == 'activate')
                                                            <span class="label label-lg label-light-success label-inline">
                                                                {{  trans('messages.admin_activate_status')  }}
                                                            </span>
                                                        @elseif($result->planDetails ?->status == 'deactivate')
                                                            <span class="label label-lg label-light-danger label-inline">
                                                                {{ trans('messages.admin_deactivate_status') }}
                                                            </span>
                                                        @endif
                                                    @else
                                                        <p>--</p> 
                                            ...
                                            <td>
                                                @if($result->is_approved == 1)
                                                    @if($result->is_active == 1)
                                                        ...
                                                        @endphp
                                                        @if($dayDifference > 30)
                                                            <span class="label label-lg label-light-danger label-inline mb-3">{{trans("messages.inactive_over_30_days")}}</span>
                                                            <br>
                                            ...
                                            <td class="text-right pr-2">
                                                @if($result->is_approved == 1)
                                                    @if($result->is_active == 1)
                                                    <a title="{{trans('messages.admin_common_Click_To_Deactivate')}}"
                                                        href='{{route("$model.status",array($result->id,0))}}'
                                                    ...
                                                    @else
                                                    <a title="{{trans('messages.admin_common_Click_To_Activate')}}"
                                                        href='{{route("$model.status",array($result->id,1))}}'
                                                    ...
                                                    @endif
                                                @elseif($result->is_approved != 2 )
                                                    <a title="{{trans('messages.admin_common_Click_To_Reject')}}"
                                                        href='{{route("$model.Approvestatus",array($result->id,2))}}'
                                                        class="btn btn-icon btn-light btn-hover-danger btn-sm status_any_item"
                                                        data-toggle="tooltip" data-placement="top" data-container="body"
                                                        data-boundary="window" data-original-title="Reject">
                                                        <span class="svg-icon svg-icon-md svg-icon-danger">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                                height="24px" viewBox="0 0 24 24" version="1.1">
                                                    ...
                                                    <a title="{{trans('messages.admin_common_Click_To_Approve')}}"
                                                        href='{{route("$model.Approvestatus",array($result->id,1))}}'
                                                        class="btn btn-icon btn-light btn-hover-success btn-sm status_any_item"
                                                        data-toggle="tooltip" data-placement="top" data-container="body"
                                                        data-boundary="window" data-original-title="Approve">
                                                        <span class="svg-icon svg-icon-md svg-icon-success">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                                height="24px" viewBox="0 0 24 24" version="1.1">
                                                ...
                                                @endif
                                                <a href="{{route($model.'.edit',array(base64_encode($result->id)))}}"
                                                    class="btn btn-icon btn-light btn-hover-primary btn-sm"
                                                    data-toggle="tooltip" data-placement="top" data-container="body"
                                                    data-boundary="window" title="" data-original-title="{{trans('messages.admin_common_Edit')}}">
                                                ...
                                                <a href="{{route($model.'.show',array(base64_encode($result->id)))}}"
                                                            class=" btn btn-icon btn-light btn-hover-primary btn-sm"
                                                    data-toggle="tooltip" data-placement="top" data-container="body"
                                                    data-boundary="window" title="" data-original-title="{{trans('messages.admin_common_View')}}">
                                                    <span class="svg-icon svg-icon-md svg-icon-primary">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                            height="24px" viewBox="0 0 24 24" version="1.1">
                                                ...
                                                <a href="{{route($model.'.delete',array(base64_encode($result->id)))}}"
                                                    class="btn btn-icon btn-light btn-hover-danger btn-sm confirmDelete"
                                                    data-toggle="tooltip" data-placement="top" data-container="body"
                                                    data-boundary="window" title="" data-original-title="{{trans('messages.admin_common_Delete')}}">
                                                    <span class="svg-icon svg-icon-md svg-icon-danger">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                            height="24px" viewBox="0 0 24 24" version="1.1">
                                                ...
                                                <a href="{{route($model.'.changedPassword',array(base64_encode($result->id)))}}"
                                                    class="btn btn-icon btn-light btn-hover-primary btn-sm"
                                                    data-toggle="tooltip" data-placement="top" data-container="body"
                                                    data-boundary="window" title=""
                                                    data-original-title="{{trans('messages.Change Password')}}">
                                                    <span class="svg-icon svg-icon-md svg-icon-primary">
                                                ...
                                                <a href='{{URL::to("adminpnlx/customers/send-credentials","$result->id")}}'
                                                    class="btn btn-icon btn-light btn-hover-primary btn-sm"
                                                    data-toggle="tooltip" data-placement="top" data-container="body"
                                                    data-boundary="window" title=""
                                                    data-original-title="{{trans('messages.admin_common_Send_Credentials')}}">
                                                    <span
                                                        class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Map/Direction2.svg--><svg
