...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					<h5 class="text-dark font-weight-bold my-1 mr-5">
						{{Config('constants.FAQ_CATEGORY.FAQ_CATEGORY_TITLE')}}
					</h5>
	...
	<div class="d-flex flex-column-fluid">
		<div class=" container ">
			<form action="{{ route('faq-category.index')}}" method="get" clas="kt-form kt-form--fit mb-0" autocomplete="off">
				<div class="row">
					<div class="col-12">
						<div class="card card-custom card-stretch card-shadowless">
							<div class="card-header">
								...
								<div class="card-toolbar">
									...
									<a href='{{route($model.".create")}}' class="btn btn-primary"> {{ trans("Add New ") }} {{Config('constants.FAQ_CATEGORY.FAQ_CATEGORY_TITLE')}}</a>
								</div>
							</div>
							<div class="card-body">
										...
										<div>
											<div class="row mb-6">
												<div class="col-lg-3 mb-lg-5 mb-6">
													<label>Title</label>
													<input type="text" name="title" class="form-control" placeholder=" title" value="{{$searchVariable->title ?? ''}}">
												</div>
												<div class="col-lg-3 mb-lg-5 mb-6">
													<label>Description</label>
													<input type="text" name="description" class="form-control" placeholder=" description" value="{{$searchVariable->description ?? ''}}">
												</div>
											</div>
											<div class="row mt-8">
												<div class="col-lg-12">
											...
											<thead>
												<tr class="text-uppercase">
													...
													<th class="{{(($sortBy == 'description' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'description' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
														<a href="{{route($model.'.index',array(	'sortBy' => 'description',
