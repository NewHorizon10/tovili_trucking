            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        Edit  {{Config('constants.FAQ_CATEGORY.FAQ_CATEGORY_TITLE')}} </h5>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="data[{{$language->id}}][description]" class="form-control form-control-solid form-control-lg @error('description') is-invalid @enderror" value="{{$multiLanguage[$language->id]['description'] ?? old('description')}}">
                                                    ...
                                                    @else
                                                    <lable for="{{$language->id}}.description">Description</lable><span class="text-danger"> </span>
                                                    <input type="text" name="data[{{$language->id}}][description]" class="form-control form-control-solid form-control-lg" value="{{$multiLanguage[$language->id]['description'] ?? old('description')}}">
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
