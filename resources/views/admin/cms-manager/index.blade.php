		...
		<div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					{{trans("messages.admin_common_Cms_Pages")}}
					</h5>
										...
										<div>
											<div class="row mb-6">
												<div class="col-lg-3 mb-lg-5 mb-6">
													<label>{{trans("messages.admin_common_page_name")}}</label>
													<input type="text" name="page_name" class="form-control" placeholder="{{trans("messages.admin_common_page_name")}}" value="{{$searchVariable->page_name ?? ''}}">
												</div>
												<div class="col-lg-3 mb-lg-5 mb-6">
													<label>{{trans("messages.admin_common_page_title")}}</label>
													<input type="text" name="title" class="form-control" placeholder="{{trans("messages.admin_common_page_title")}}" value="{{$searchVariable->title ?? ''}}">
												</div>
											</div>
											<div class="row mt-8">
												<div class="col-lg-12">
										...
										<table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
											<thead>
												<tr class="text-uppercase">
													...
													$query_string))}}">{{trans("messages.admin_common_page_name")}}</a>
													</th>
													...
													$query_string))}}"> {{trans("messages.admin_common_page_title")}}</a>
													</th>
											...
											<tbody>
												...
												<tr>
													...
													<td class="text-right pr-2">
														<a href="{{route($modelName.'.edit',base64_encode($result->id))}}" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="{{trans('messages.admin_common_Edit')}}">
