								...
								<div class="row">
									<div class="col-xl-6">
										<div class="form-group">
											...
											<input type="password" name="old_password" class="form-control form-control-solid form-control-lg  @error('old_password') is-invalid @enderror" oninput="validatePassword(this);" onpaste="validatePassword(this);" value="{{$userDetails->last_name ?? old('old_password')}}">
