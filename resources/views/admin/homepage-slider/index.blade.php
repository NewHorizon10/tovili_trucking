                            ...
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href="{{route($model.'.create')}}" class="btn btn-primary"> 
                                        {{trans("messages.admin_common_Add_New")}} {{trans("messages.admin_common_Homepage_Slider")}} 
                                    </a>
                                </div>
                            </div>
                            <div class="card-body">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                     ...
                                                     @if (!empty($result->image))
                                                            <a class="fancybox-buttons" data-fancybox-group="button" href="<?php echo Config('constants.SLIDER_IMAGE_PATH') . $result->image; ?>">
                                                                <img width="70px" height="50px"src="{{ Config('constants.SLIDER_IMAGE_PATH') . $result->image }}" />
                                                            </a>
                                                        @endif
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-right pr-2">
                                                        ...
                                                        <a href="{{route($model.'.delete',['encatid'=>base64_encode($result->id)])}}" class="btn btn-icon btn-light btn-hover-danger btn-sm confirmDelete" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="{{trans('messages.admin_common_Delete')}}">
