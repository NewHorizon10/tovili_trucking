                    ...
                    <div class="card card-custom card-stretch card-shadowless">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                ...
                                {{trans("messages.add_new_truck_type")}}</a>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div>
                                        <div class="row mb-6">
                                            <div class="col-lg-3 mb-lg-5 mb-6">
                                                ...
                                                <input name="name" class="form-control select2init" value="{{$searchVariable['name'] ?? ''}}">
                                            </div>
                                            <div class="col-lg-3 mb-lg-5 mb-6">
                            ...
                            <div class="dataTables_wrapper ">
                                ...
                                <td class="text-right pr-2">
                                    ...
                                    <a href="{{route($model.'.questionnaire.index',array(base64_encode($result->id)))}}" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="{{trans('messages.admin_common_Features')}}">
