                    ...
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            ...
                            <a href='{{route("$model.create")}}' class="btn btn-primary"> 
                                {{ trans("Add New ") }} Private Customer
                            </a>
                                ...
                                <div>
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-lg-3 mb-lg-5 mb-6">
                                            ...
                                            <input type="text" class="form-control" name="company_id" placeholder="Company ID" value="{{$searchVariable['company_id'] ?? '' }}">
                                        </div>

                                        <div class="col-lg-3 mb-lg-5 mb-6">
                                            <label>Company Name</label>
                                            <input type="text" class="form-control" name="company_name" placeholder="Company Name" value="{{$searchVariable['company_name'] ?? '' }}">
                                        </div>
                                        ...
                                        <div class="col-lg-3 mb-lg-5 mb-6">
                                            ...
                                            <input type="text" class="form-control" name="company_location" placeholder="Company Location" value="{{$searchVariable['company_location'] ?? '' }}">
                                        </div>
                                    ...
                                    <thead>
                                        ...
                                        <th class="{{(($sortBy == 'id' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'id' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                               ...
                                               <th class="{{(($sortBy == 'id' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'id' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                <a href="{{route($model.'.index',array(	'sortBy' => 'id',
                                                   'order' => ($sortBy == 'id' && $order == 'desc') ? 'asc' : 'desc',	
                                                   $query_string))}}">Company Location</a>
                                               </th>
                                               ...
                                               <tbody>
                                                ...
                                                <tr>
                                                  ...
                                                  <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                        {{ $result->userCompanyInformation->company_id  ?? ''}}
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">
                                                        {{ $result->userCompanyInformation->company_name  ? $result->userCompanyInformation->company_name : ''}}
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if (!empty($result->userCompanyInformation->company_logo))
                                                            <a class="fancybox-buttons" data-fancybox-group="button" href="<?php echo Config('constants.COMPANY_LOGO_IMAGE_PATH') . $result->userCompanyInformation->company_logo; ?>">
                                                                <img width="70px" height="50px" alt="{{ trans('messages.admin_common_Image') }}" src="{{ Config('constants.COMPANY_LOGO_IMAGE_PATH') . $result->userCompanyInformation->company_logo }}" />
                                                            </a>
                                                        @endif
                                                        </div>
                                                    </td>
                                                ...
                                                <a href="{{route($model.'.changedPassword',array(base64_encode($result->id)))}}" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="Change Password">
                                                    <span class="svg-icon svg-icon-md svg-icon-primary">
                                                ...
                                                <a href='{{URL::to("adminpnlx/customers/send-credentials","$result->id")}}' class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="Send Credentials">
