...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
		...
		<div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    {{trans("messages.customer_support")}}
					</h5>
	...
	<div class="d-flex flex-column-fluid">
		<div class="container-fluid">
                <div class="card card-custom card-stretch card-shadowless customer_support_box">
                                                                        ...
                                                                        <div class="media mediaChatdiscover">
                                                                            <div class="media-body overflow-hidden">
                                                                                <div class="mess_chatDiscover">
                                                                                    <div class="chatDiscover_img message_top_img">
                                                                                        <img width="25px" height="25px" src="{{ $messagesDetails_data->reciver_image }}" alt="">
                                                                                    </div>
                                                                                    <div class="chatDiscover_title">
                                                                                        <h4>{{ $messagesDetails_data->name }}</h4>
                                                                                        @if($messagesDetails_data->message_type == 'attachment')
                                                                                        <img width="25px" height="25px" class="chatUser" src="{{Config('constants.MESSAGE_IMAGES_IMAGE_PATH').$messagesDetails_data->last_message }}" alt="">
                                                                                        
                                                                                        @else
                                                                                        <span>{{ $messagesDetails_data->last_message ?? '' }}</span>
                                                                                        @endif
                                                                                    </div>
                                                                                </div>
                                                                                <div class="mess_dateNotiBox">
                                                                                    <div class="badge-top-right">
                                                                                        ...
                                                                                        <span>{{ $messagesDetails_data->total_unread_sms ?? '' }}</span>
                                                                                        @endif
                                                                                    </div>
                                                                                    <div class="msg-time">{{ $messagesDetails_data->last_message_date ?? '' }}</div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class="chat-header" id="chatHeader">
                                                    <div class="row g-0 align-items-center">
                                                                ...
                                                                <div class="user_message_name">
                                                                    ...
                                                                    <div class="message_user_img">
                                                                        <div class="message_top_img">
                                                                            <a href="{{ $selectedUser['receiver_data']->image ?? ''}}" class="receiver_image" data-fancybox="userimage">
                                                                                <img width="25px" height="25px" class="receiver_image" src="{{ $selectedUser['receiver_data']->image != null ? $selectedUser['receiver_data']->image : config('constants.NO_IMAGE_PATH')  }}" alt="" >
                                                                            </a>
                                                                        </div>
                                                                    ...
                                                                    <div class="call_info_box">
                                                                        ...
                                                                        <a href="tel:{{ $selectedUser['receiver_data']->phone_number ?? ''}}" class="chet_icon_color receiver_call">
                                                        ...
                                                        <span class="span-relative">
                                                            ...
                                                            <input type="hidden" value="1" class="property_id">
                                                            <input type="hidden" value="{{ $auth->is_online }}" class="is_online">
                                                            <input type="hidden" value="{{ $auth->id }}" class="sender_id">
                                                        </span>
                                                        <div class="dashChatChattingInner appendChat chatInner_block" id="chatInner">
                                                            ...
                                                            @foreach($selectedUser['data'] as $selectedUserChat)
                                                                @php
                                                                    $messageDate = $selectedUserChat->date; 
...
<script>
    ...
    socket.on( 'sendEmitMessageResponce', function(data) {
        ...
        if(data.property_id == id && data.sender_id == listid ){
            var chekside = 0;
            var sidehtml = '';
            var htmls = 
    `<div class="message message-right appendChatChild">
        <div class="message-body">
            <div class="message-row">
                <div class="d-flex align-items-centers">
                    <div class="message-content-block">
                        <figure class="message_leftImg"><img src="${data.sender_image ? data.sender_image : ImageUrl}" alt=""></figure>`;
                            if(data.message != ''){
                                htmls += 
                                    `<div class="message-content">
                                ...
                                <div class="card-body">
                                    <div class="media mediaChatdiscover">
                                        <div class="media-body overflow-hidden">
                                            <div class="mess_chatDiscover">
                                                <div class="chatDiscover_img message_top_img">
                                                    <img width="25px" height="25px"  src="${val.reciver_image}" alt="">
                                                </div>
                                                <div class="chatDiscover_title">
                                                    <h4>${val.name}</h4>
                ...
                success: function(response) {
                    $.each(response,function(key,val) {
                        ...
                        if(extFile=="jpg" || extFile=="jpeg" || extFile=="png" || extFile=="mp4" || extFile=="pdf" || extFile=="zip" || extFile=="odt" || extFile=="docx" || extFile=="xlsx"){
                            ...
                            if(type[0] == 'image'){
                                var html = 
                                `<button type="download" class="btn  bg_none_dowload_file mb-3 img-select-box p-1 m-1">
                    ...
                    if(response){
                        if(response.receiver_data != ''){
                            ...
                            if(response.receiver_data.is_online == 0){
                                $('.is_online_chk').text('offline')
                            }else{
                                $('.is_online_chk').text('Active')
                            }

                            $('.receiver_name').text(response.receiver_data.name)
                            $(".receiver_image").attr("src",response.receiver_data.image);
                            $(".receiver_image").attr("href",response.receiver_data.image);
                            $(".receiver_call").attr("href",'tel:'+response.receiver_data.phone_number);
                            ...
                            $.ajax({
                                ...
                                type:'POST',
                                url: '{{ route('admin.toggle_chat_html') }}',
                                data: form_data,
                                contentType: false,
                                processData: false,
                            ...
                            $.ajax({
                                ...
                                type:'POST',
                                url: '{{ route('admin.toggle_chat_media') }}',
                                data: form_data,
                                contentType: false,
                                processData: false,
