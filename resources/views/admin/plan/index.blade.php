                    ...
                    <div class="card card-custom card-stretch card-shadowless">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                ...
                                {{trans("messages.admin_common_Add_New")}} {{trans("messages.admin_common_Plan")}}</a>
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <div class="row mb-6">
                                            <div class="col-lg-3 mb-lg-5 mb-6">
                                                ...
                                                <select name="is_active" class="form-control select2init" value="{{$searchVariable['is_active'] ?? ''}}">
                                                    ...
                                                    <option value="1" {{ isset($searchVariable['is_active']) && $searchVariable['is_active'] == 1 ? 'selected': '' }}>
                                                        {{trans("messages.admin_common_Activate")}}
                                                    </option>
                                                    <option value="0" {{ isset($searchVariable['is_active']) && $searchVariable['is_active'] == 0 ? 'selected': '' }}>
                                             ...
                                             <div class="col-lg-3 mb-lg-5 mb-6">
                                                ...
                                                <select name="is_free" class="form-control select2init" value="{{$searchVariable['is_active'] ?? ''}}">
                                                    <option value="">{{trans("messages.admin_All")}}</option>
                            ...
                            <div class="dataTables_wrapper ">
                                    ...
                                    <table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
                                        <thead>
                                            <tr class="text-uppercase">
                                                <th>
                                                    {{trans("messages.admin_common_Image")}}
                                                </th>
                                                ...
                                                <th class="{{(($sortBy == 'price' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'price' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                   ...
                                                   $query_string))}}">{{trans("messages.admin_common_Price")}}</a>
                                                </th>
                                            ...
                                            <tr>
                                                <td>
													...
													<div class="text-dark-75 mb-1 font-size-lg">
                                                        <a class="fancybox-buttons" data-fancybox-group="button" href="{{asset( Config('constants.PLAN_IMAGE_ROOT_PATH').$result->image) }}">
                                                            <img height="50" width="50" src="{{asset( Config('constants.PLAN_IMAGE_PATH').$result->image) }}" />
                                                        </a>															
                                                    </div>
													@endif
                                                </td>
                                ...
                                <td class="text-right pr-2">
                                    ...
                                    <a href="{{route($model.'.show',array(base64_encode($result->id)))}}"
                                                            class=" btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="{{trans('messages.admin_common_View')}}">
                                        <span class="svg-icon svg-icon-md svg-icon-primary">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect x="0" y="0" width="24" height="24" />
                                    ...
                                    <a href="{{route($model.'.feature.index',array(base64_encode($result->id)))}}" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="{{trans('messages.admin_common_Features')}}">
