                ...
                <div class="card card-custom card-stretch card-shadowless">
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            ...
                            <a href='{{route("$model.create")}}' class="btn btn-primary mx-2"> 
                            {{trans("messages.admin_Add_New_Private_Customer")}}
                            </a>
                                ...
                                <div>
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-lg-3 mb-lg-5 mb-6">
                                            ...
                                            <input type="text" class="form-control" name="names" placeholder="{{trans('messages.name')}}" value="{{$searchVariable['names'] ?? '' }}">
                                        </div>
                                        ...
                                        <div class="col-lg-3 mb-lg-5 mb-6">
                                            ...
                                            <input type="text" class="form-control" name="location" placeholder="{{trans('messages.location')}}" value="{{$searchVariable['location'] ?? '' }}">
                                        </div>
                                    ...
                                    <thead>
                                        <tr class="text-uppercase">
                                              <th class="{{(($sortBy == 'system_id' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'system_id' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                               ...
                                               <th class="{{(($sortBy == 'names' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'names' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                <a href="{{route($model.'.index',array(	'sortBy' => 'names','order' => ($sortBy == 'names' && $order == 'desc') ? 'asc' : 'desc',	
                                               ...
                                               <th class="{{(($sortBy == 'location' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'location' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                <a href="{{route($model.'.index',array(	'sortBy' => 'location',
                                                   'order' => ($sortBy == 'location' && $order == 'desc') ? 'asc' : 'desc',	
                                                   $query_string))}}">{{trans("messages.location")}}</a>
                                               </th>
