        ...
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    {{trans("messages.admin_Edit_Private_Customer")}}
                </h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="location" id="company_location" class="form-control form-control-solid form-control-lg  @error('location') is-invalid @enderror" value="{{old('location') ?? $userDetails->location}}">
