      ...
      <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
         <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
               ...
               {{trans("messages.admin_View_Private_Customer")}}
               </h5>
            ...
            <div class="card-body px-0">
               <div class="tab-content px-10">
                  ...
                  <div class="tab-pane active" id="kt_apps_contacts_view_tab_1" role="tabpanel">
                     ...
                     <div class="form-group row my-2">
                        <label class="col-4 col-form-label">{{trans("messages.location")}} :</label>
                        <div class="col-8">
                           <span class="form-control-plaintext font-weight-bolder">{{$userDetails->location ?? ''}}</span>
                        </div>
                     </div>
                            ...
                            <table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                    ...
                                    <td>{{$shipment?->shipmentDriverScheduleDetails?->companyInformation?->company_name ?? '---'}}</td>
