...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    {{trans("messages.admin_common_team_update")}}
                    </h5>
    ...
    <div class="d-flex flex-column-fluid">
        <div class=" container ">
            <form action="{{route('team.edit',array(base64_encode($team->id)))}}" method="post" class="mws-form" autocomplete="off" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="tab-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="data[{{$language->id}}][designation]" class="form-control form-control-solid form-control-lg @error('designation') is-invalid @enderror" value="{{@$multiLanguage[$language->id]['designation']}}">
                                                    ...
                                                    @else
                                                    <label for="{{$language->id}}.designation">{{trans("messages.admin_common_Designation")}}</label><span class="text-danger"> </span>
                                                    <input type="text" name="data[{{$language->id}}][designation]" class="form-control form-control-solid form-control-lg" value="{{@$multiLanguage[$language->id]['designation']}}">
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    @endif
                                    @if (!empty($team->image))
                                    <a class="fancybox-buttons" data-fancybox-group="button" href="<?php echo Config('constants.TEAM_IMAGE_PATH') . $team->image; ?>">
                                        <img width="100px" height="80" alt="{{ trans('messages.admin_common_Image') }}" src="{{ Config('constants.TEAM_IMAGE_PATH') . $team->image }}" />
                                    </a>
                                    @endif
                                </div>
                            </div>
