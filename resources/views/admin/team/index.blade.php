...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <?php
    $createPermission   = functionCheckPermission("FrontPagesController@teamAdd");
    $deletePermission   = functionCheckPermission("FrontPagesController@teamDelete");
    ?>

    <div class="d-flex flex-column-fluid">
        <div class=" container ">
            {{ Form::open(['method' => 'get','role' => 'form','route' => "team.index",'class' => 'kt-form kt-form--fit mb-0','autocomplete'=>"off"]) }}
            {{ Form::hidden('display') }}
            <div class="row">
                <div class="col-12">
                    <div class="card card-custom card-stretch card-shadowless">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                ...
                                <a href='{{route("team.add")}}' class="btn btn-primary">
                                {{trans("messages.admin_common_Add_New")}} {{trans("messages.admin_common_Team")}}
                                </a>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <div id="collapseOne6" class="collapse <?php echo !empty($searchVariable) ? 'show' : ''; ?>" data-parent="#accordionExample6">
                                    <div>
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-3 mb-lg-5 mb-6">
                                                <label>{{trans("messages.admin_common_Designation")}}</label>
                                                <input type="text" class="form-control" name="designation" placeholder="{{trans("messages.admin_common_Designation")}}" value="{{$searchVariable['designation'] ?? '' }}">
                                            </div>
                                        ...
                                        <div class="row mt-8">
                                            <div class="col-lg-12">
                                                ...
                                                &nbsp;&nbsp;
                                                <a href='{{ route("team.index")}}' class="btn btn-secondary btn-secondary--icon">
                                                    <span>
                                        ...
                                        <thead>
                                            <tr class="text-uppercase">
                                                ...
                                                <th class="{{(($sortBy == 'name' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'name' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    <a href="{{route('team.index',array(	'sortBy' => 'name','order' => ($sortBy == 'name' && $order == 'desc') ? 'asc' : 'desc',	
                                                   $query_string))}}">{{trans("messages.admin_common_profile_image")}}</a>
                                                </th>
                                                <th class="{{(($sortBy == 'name' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'name' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    <a href="{{route('team.index',array(	'sortBy' => 'name','order' => ($sortBy == 'name' && $order == 'desc') ? 'asc' : 'desc',	
                                                ...
                                                <th class="{{(($sortBy == 'id' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'id' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    <a href="{{route('team.index',array(	'sortBy' => 'id',
                                                   'order' => ($sortBy == 'id' && $order == 'desc') ? 'asc' : 'desc',	
                                                   $query_string))}}">{{trans("messages.admin_common_Designation")}}</a>
                                                </th>

                                                <th class="{{(($sortBy == 'created_at' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'created_at' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    <a href="{{route('team.index',array(	'sortBy' => 'created_at',
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                        <a class="fancybox-buttons" data-fancybox-group="button" href="{{url(Config('constants.TEAM_IMAGE_PATH').$result->image)}}">
                                                            <img height="50" width="50" src="{{url(Config('constants.TEAM_IMAGE_PATH').$result->image)}}" />
                                                        </a>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-right pr-2">
                                                    ...
                                                    <a href="{{route('team.edit',array(base64_encode($result->id)))}}" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="{{trans('messages.admin_common_Edit')}}">
                                                    ...
                                                    <a href="{{route('team.delete',array(base64_encode($result->id)))}}" class="btn btn-icon btn-light btn-hover-danger btn-sm confirmDelete" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="{{trans('messages.admin_common_Delete')}}">
