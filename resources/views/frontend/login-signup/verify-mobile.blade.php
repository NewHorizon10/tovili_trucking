...
@section('content')
<?php
$type = ucfirst(Session::get('userTypeData'));
...
<section class="form_section">
    <div class="container">
        <div class="outer_form_box">
            <div class="form_box">
                <form action="{{route('verify-mobile')}}" method="post" class="client_form_theme">
                    @csrf
                    <h1 class="form_page_title">
                        <a href="{{ url('chooce-customer') }}" class="back_btn">
                     ...
                     <div class="form-group">
                        <label for="exampleInputEmail1" class="form-label">{{trans('messages.Phone Number')}}</label>
                            <!-- <div class="input-group only_left mb-3"> -->
                                ...
                                <input type="text" name="phone_number" class="form-control @error('phone_number') is-invalid @enderror" value="{{old('phone_number')}}" oninput="validatePhoneNumber(this);" onpaste="validatePhoneNumber(this);" id="exampleInputEmail1"
