        ...
        <div class="dashboardRight_block_wrapper">
            ...
            <div class="requestBoxes">
                <div class="row gy-3">
                    <div class="col-md-6 col-lg-6">
                        <a href="{{route('business.shipment.view-all')}}">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <a href="{{route('business.shipment-requests.view-all')}}?status=new">
                            <div class="mothlyRequestBox">
                                <div class="requestIcon-box">
            ...
            <div class="dashboard_table">
                <div class="tableTop-title">
                    ...
                    <a href="{{route('business.notification-list')}}" class="tableTopLink">{{trans('messages.View_All')}}</a>
                </div>
                <div class="dashboard_notofication_main">
                    ...
                    @if($notifications->count())
                        ...
                        <li 
                            ...
                            @elseif($notification->shipments_status == "shipment" || $notification->shipments_status == "end" )
                                    onclick="window.location = '{{ route('business-shipment-details', [$notification->request_number]) }}'"
                                @elseif($notification->shipments_status == "offers" || $notification->shipments_status == "new" || $notification->shipments_status == "offer_chosen")
                                    onclick="window.location = '{{ route('business-shipment-request-details', [$notification->request_number]) }}'"
                                @endif
            ...
            <div class="dashboard_table">
                <div class="tableTop-title">
                    ...
                    <a href="{{route('business.shipment-requests.view-all')}}" class="tableTopLink">{{trans('messages.View_All')}}</a>
                </div>
                        ...
                        <table class="table">
                            ...
                            @if($ShipmentRequestList->count())
                                ...
                                <tr class="table-tr" onclick="window.location = '{{route('business-shipment-request-details',[$shipment->request_number])}}'" style="cursor: pointer;">
                                    ...
                                    <td>
                                        <a class="date_label date_label_new" href="javascript:void(0)">
                                    ...
                                    <td>
                                        <div class="address-box">{{$shipment->pickup_city}}</div>
                                    </td>
                                    <td>
            ...
            <div class="dashboard_table">
                <div class="tableTop-title">
                    ...
                    <a href="{{route('business.transportation.view-all')}}" class="tableTopLink">{{trans('messages.View_All')}}</a>
                </div>
                <div class="dashboard_notofication_main dahboard_whiteSpace">
                    <div class="table-responsive dashboard_notofication">
                    <table class="table">
