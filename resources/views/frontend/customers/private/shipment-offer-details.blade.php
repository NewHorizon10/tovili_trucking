            ...
            <div class="dashboard_notofication_main List_objectives_table">
                <div class="transportation_request_block offer_details_content">
                    ...
                    <div class="company_offreDetails">
                        ...
                        <h3 class="offreDetails_cont">: {{$shipment->TruckTypeDescriptionsPrivate->name ?? ""}}</h3>
                    </div>
                    ...
                    {{--
                        <div class="company_offreDetails">
                            ...
                            <h3 class="offreDetails_cont">: {{$shipmentOffer->duration_in_hours}} {{$shipmentOffer->duration_in_hours > 0 ? "days" : "day" }}
                        </div>
                    --}}
                    <div class="company_offreDetails">
                        <span class="company_offreDetails_label">{{trans('messages.duration_in_hours')}}</span>
                    ...
                    <!-- <div class="company_offreDetails">
                        ...
                        <h3 class="offreDetails_cont">: {{$shipmentOffer->TruckDetail ? $shipmentOffer->TruckDetail->truck_system_number : ''}}</h3>
                    </div> -->
                    <div class="company_offreDetails">
