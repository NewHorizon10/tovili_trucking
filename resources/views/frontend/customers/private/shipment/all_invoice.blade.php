                    ...
                    <div class="table-responsive dashboard_notofication">
                        <table class="table">
                            ...
                            @if($ShipmentList->count())
                                ...
                                <tr class="table-tr">
                                     <td>
                                        <a href="{{route('private-shipment-details',[$shipment->request_number])}}" style="text-decoration: none; color: #3498db; font-weight: bold; transition: color 0.3s ease;" onmouseover="this.style.color='#e74c3c'" onmouseout="this.style.color='#3498db'">
                                    ...
                                    <td>
                                        ...
                                        <a class="date_label_1" href="javascript:void(0)">
                              ...
                              if($extension == "png" || $extension == "jpg" || $extension == "jpeg"|| $extension == "svg"){
                                    @endphp 
                                        <a class="fancybox-buttons" data-fancybox-group="button" href="{{asset( Config('constants.INVOICE_FILE_ROOT_PATH').$shipment->invoice_file) }}" >
                                            <div class="upload_img_item tabel_img">
                                                <img  src="{{asset( Config('constants.INVOICE_FILE_ROOT_PATH').$shipment->invoice_file) }}" alt="">
                                            ...
                                            <a href="{{ asset(Config('constants.INVOICE_FILE_ROOT_PATH') . $shipment->invoice_file) }}" class="blue_btn dashboard_tableBtn" download>Download
                                    </a>
                                     @php
                                    ...
                                    <a href="{{ asset(Config('constants.INVOICE_FILE_ROOT_PATH') . $shipment->invoice_file) }}" target="_blank">
                                        ...
                                        <a href="{{ asset(Config('constants.INVOICE_FILE_ROOT_PATH') . $shipment->invoice_file) }}" class="blue_btn dashboard_tableBtn downld" download>Download                                    </a>
                                    @php
                                }
                                @endphp
                                   </td>
