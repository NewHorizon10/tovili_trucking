                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse">
                        @if (Auth::user())
                                ...
                                @auth
                                    <div class="nav-item dropdown user_dropdown">
                                        <a class="nav-link dropdown-toggle" href="javascript:void(0);" id="user-drop"
                                            ...
                                            <img src="{{ Auth::user()->image != null ? Auth::user()->image : config('constants.NO_IMAGE_PATH') }}"
                                                alt="">
                            ...
                            {{-- {{ request()->routeIs(Auth::user()->customer_type.'.customer-dashboard') ? 'active' : '' }} --}}
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item langugae_filter for_desktop">
                                    <a class="nav-link extra_btn dropdown-toggle lang_drop"
                                        ...
                                        <span class="flag_ico"><img
                                                src="{{ config('constants.LANGUAGE_IMAGE_PATH') . $image }}"
                                                alt=""></span> {{ strtoupper($select_lang) }} <i
                                    ...
                                    <li class="nav-item langugae_filter for_desktop">
                                        <div class="nav-item dropdown user_dropdown">
                                            <a class="nav-link dropdown-toggle" href="javascript:void(0);" id="user-drop"
                                                role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
                                                <h4><span>{{ trans('messages.Login as') }}:</span>
                                                    {{ ucfirst(Auth::user()->customer_type) }}
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="user-drop">
                                                <div class="user_info">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="{{ route('customers-profile') }}"><i
                                                                    class="ion-android-person"></i>{{ trans('messages.My Profile') }}</a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ route('user-logout') }}"><i
                                                                    class="ion-log-out"></i>{{ trans('messages.Logout') }}</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                ...
                                @guest
                                    <li class="nav-item login_btn">
                                        <a class="nav-link secondary-btn"
                                            href="{{ route('login') }}">{{ trans('messages.login') }}</a>
                                    </li>
                                @endauth
                                <!-- @auth
                                            <li class="nav-item login_btn">
                                                <a class="nav-link secondary-btn" href="{{ route('user-logout') }}">{{ trans('messages.Logout') }}</a>
                                            </li>
                                @endauth-->

                                <li class="nav-item sign_up_btn">
                                    @if (Auth::user() && Auth::user()->customer_type == 'business')
                                        <a class="nav-link primary-btn"
                                            href="{{ route('business-shipment-request') }}">{{ trans('messages.Book a Shipment') }}</a>
                                    @elseif(Auth::user() && Auth::user()->customer_type == 'private')
                                        <a class="nav-link primary-btn"
                                            href="{{ route('private-shipment-request') }}">{{ trans('messages.Book a Shipment') }}</a>
                                    @else
                                        <a class="nav-link primary-btn"
                                            href="{{ route('private-shipment-request') }}">{{ trans('messages.Book a Shipment') }}</a>
                                    @endif
                            ...
                            <ul class="navbar-nav ms-auto">
                                ...
                                <li class="nav-item langugae_filter ">
                                    ...
                                    <div class="lang_dropdown">
                                        @if (!empty($languageslist))
                                            @foreach ($languageslist as $item)
                                                <div class="lang_country" id="">
                                                    <a href="{{ route('lang.switch', $item->lang_code) }}"
                                                        data-code="{{ $item->lang_code }}">
                                                        <span class="flag_ico">
                                                            <img src="{{ config('constants.LANGUAGE_IMAGE_PATH') . $item->image }}"
                                                                alt="">
                                                        </span> {{ $item->title }}
                            ...
                            <ul class="navbar-nav ms-auto">
                                <li class="nav-item langugae_filter ">
                                    <a class="nav-link extra_btn dropdown-toggle lang_drop"
                                        href="javascript:void(0);">
                                        <span class="flag_ico">
                                            <img src="https://tovilli.dev.obdemo.com/public/uploads/language_image/226-united-states.svg"
                                                alt="">
                                        </span> EN
                                    </a>
                                    <div class="lang_dropdown">
                                        <div class="lang_country" id="">
                                            <a href="https://tovilli.dev.obdemo.com/change-language-settings/en"
                                                data-code="en">
                                                <span class="flag_ico">
                                                    <img src="https://tovilli.dev.obdemo.com/public/uploads/language_image/226-united-states.svg"
                                                        alt="">
                                        ...
                                        <div class="lang_country" id="">
                                            <a href="https://tovilli.dev.obdemo.com/change-language-settings/he"
                                                data-code="he">
                                                <span class="flag_ico">
                                                    <img src="https://tovilli.dev.obdemo.com/public/uploads/language_image/hebrew.png"
                                                        alt="">
                                                </span> Hebrew
                                            </a>
                                        </div>
                                        <div class="lang_country" id="">
                                            <a href="https://tovilli.dev.obdemo.com/change-language-settings/ar"
                                                data-code="ar">
                                                <span class="flag_ico">
                                                    <img src="https://tovilli.dev.obdemo.com/public/uploads/language_image/saudi_arabia.svg"
                                                        alt="">
                                                </span> Arabic
                                            </a>
                                        </div>
