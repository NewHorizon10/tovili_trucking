...
$type = ucfirst(Auth::user()->customer_type);
            ...
            <div class="col-12">
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse">
                        <div class="user_dropdown_forMobile">
                            @auth
                                <div class="nav-item dropdown user_dropdown">
                                    <a class="nav-link dropdown-toggle" href="javascript:void(0);" id="user-drop"
                                        role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <h4><span>{{ trans('messages.Login as') }}:</span> {{ trans("messages.$type") }}
                                        </h4>
                                        <img src="{{getUserProfileImage(Auth::user()->id)}}">
                                    </a>
                                    <div class="dropdown-menu" aria-labelledby="user-drop">
                                        <div class="user_info">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="{{ route('customers-profile') }}"><i
                                                            class="ion-android-person"></i>
                                                        {{ trans('messages.My Profiles') }}</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('user-logout') }}"><i class="ion-log-out"></i>
                        ...
                        <ul class="navbar-nav side_menu_forMobile">
                            <li class="nav-item {{ request()->routeIs(Auth::user()->customer_type.'.customer-dashboard') ? 'active' : '' }}">
                                <a href="{{ route(Auth::user()->customer_type . '.customer-dashboard') }}"
                                    class="nav-link">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M9.58301 1.875C9.92819 1.875 10.208 2.15482 10.208 2.5L10.208 8.33333C10.208 8.67851 9.92819 8.95833 9.58301 8.95833L2.49967 8.95833C2.1545 8.95833 1.87467 8.67851 1.87467 8.33333L1.87467 2.5C1.87467 2.15482 2.1545 1.875 2.49967 1.875L9.58301 1.875ZM8.95801 3.125L3.12467 3.125L3.12467 7.70833L8.95801 7.70833L8.95801 3.125Z"
                                            fill="black" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M17.5 11.0416C17.8452 11.0416 18.125 11.3214 18.125 11.6666V17.5C18.125 17.8451 17.8452 18.125 17.5 18.125H10.4167C10.0715 18.125 9.79167 17.8451 9.79167 17.5L9.79167 11.6666C9.79167 11.3214 10.0715 11.0416 10.4167 11.0416L17.5 11.0416ZM16.875 12.2916L11.0417 12.2916V16.875H16.875V12.2916Z"
                                            fill="black" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M12.917 8.95837C12.5718 8.95837 12.292 8.67855 12.292 8.33337V2.50004C12.292 2.15486 12.5718 1.87504 12.917 1.87504H17.5003C17.8455 1.87504 18.1253 2.15486 18.1253 2.50004V8.33337C18.1253 8.67855 17.8455 8.95837 17.5003 8.95837H12.917ZM13.542 7.70837H16.8753V3.12504H13.542V7.70837Z"
                                            fill="black" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M2.5 18.125C2.15482 18.125 1.875 17.8452 1.875 17.5L1.875 11.6667C1.875 11.3215 2.15482 11.0417 2.5 11.0417H7.08333C7.42851 11.0417 7.70833 11.3215 7.70833 11.6667V17.5C7.70833 17.8452 7.42851 18.125 7.08333 18.125H2.5ZM3.125 16.875H6.45833V12.2917H3.125L3.125 16.875Z"
                                            fill="black" />
                                    </svg>
                            ...
                            @if (Auth::user()->customer_type == 'business')
                                <li class="nav-item {{ request()->routeIs(Auth::user()->customer_type.'.shipment-requests.view-all') ? 'active' : '' }}">
                                ...
                                <li class="nav-item {{ request()->routeIs(Auth::user()->customer_type.'.shipment.all-invoice') ? 'active' : '' }}">
                                ...
                                <li class="nav-item {{ request()->routeIs(Auth::user()->customer_type.'.transportation.view-all') ? 'active' : '' }}">
                                    <a href="{{route('business.transportation.view-all')}}" class="nav-link">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                d="M9.72082 1.10761C9.89677 1.01963 10.1039 1.01963 10.2798 1.10761L18.6132 5.27428C18.8249 5.38015 18.9587 5.59656 18.9587 5.83329V14.1666C18.9587 14.4034 18.8249 14.6198 18.6132 14.7256L10.2798 18.8923C10.1039 18.9803 9.89677 18.9803 9.72082 18.8923L1.38748 14.7256C1.17574 14.6198 1.04199 14.4034 1.04199 14.1666V5.83329C1.04199 5.59656 1.17574 5.38015 1.38748 5.27428L9.72082 1.10761ZM2.29199 6.21956V13.7804L10.0003 17.6345L17.7087 13.7804V6.21956L10.0003 2.3654L2.29199 6.21956Z"
                                                fill="black" />
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                d="M1.10811 5.55388C1.26248 5.24514 1.6379 5.12 1.94664 5.27437L10.28 9.44104C10.5887 9.59541 10.7138 9.97083 10.5595 10.2796C10.4051 10.5883 10.0297 10.7134 9.72095 10.5591L1.38762 6.39241C1.07888 6.23804 0.953744 5.86262 1.10811 5.55388Z"
                                                fill="black" />
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                d="M10 9.375C10.3452 9.375 10.625 9.65482 10.625 10V18.3333C10.625 18.6785 10.3452 18.9583 10 18.9583C9.65482 18.9583 9.375 18.6785 9.375 18.3333V10C9.375 9.65482 9.65482 9.375 10 9.375Z"
                                                fill="black" />
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                d="M18.8925 5.55388C19.0469 5.86262 18.9217 6.23804 18.613 6.39241L10.2796 10.5591C9.97091 10.7134 9.59549 10.5883 9.44112 10.2796C9.28675 9.97083 9.41189 9.59541 9.72063 9.44104L18.054 5.27437C18.3627 5.12 18.7381 5.24514 18.8925 5.55388Z"
                                                fill="black" />
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                d="M14.7255 3.47051C14.8799 3.77924 14.7547 4.15466 14.446 4.30903L6.11265 8.4757C5.80392 8.63007 5.4285 8.50493 5.27413 8.19619C5.11976 7.88745 5.2449 7.51203 5.55364 7.35766L13.887 3.191C14.1957 3.03663 14.5711 3.16177 14.7255 3.47051Z"
                                                fill="black" />
                                        </svg>
                            ...
                            @endif
                            <li class="nav-item {{ request()->routeIs('customers-profile') ? 'active' : '' }}">
                                <a href="{{ route('customers-profile') }}" class="nav-link">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M10.0003 2.29163C8.50455 2.29163 7.29199 3.50419 7.29199 4.99996C7.29199 6.49573 8.50455 7.70829 10.0003 7.70829C11.4961 7.70829 12.7087 6.49573 12.7087 4.99996C12.7087 3.50419 11.4961 2.29163 10.0003 2.29163ZM6.04199 4.99996C6.04199 2.81383 7.8142 1.04163 10.0003 1.04163C12.1865 1.04163 13.9587 2.81383 13.9587 4.99996C13.9587 7.18609 12.1865 8.95829 10.0003 8.95829C7.8142 8.95829 6.04199 7.18609 6.04199 4.99996Z"
                                            fill="black" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M1.875 18.3334C1.875 13.8461 5.5127 10.2084 10 10.2084C14.4873 10.2084 18.125 13.8461 18.125 18.3334C18.125 18.6786 17.8452 18.9584 17.5 18.9584C17.1548 18.9584 16.875 18.6786 16.875 18.3334C16.875 14.5364 13.7969 11.4584 10 11.4584C6.20305 11.4584 3.125 14.5364 3.125 18.3334C3.125 18.6786 2.84518 18.9584 2.5 18.9584C2.15482 18.9584 1.875 18.6786 1.875 18.3334Z"
                                            fill="black" />
                                    </svg>
                            ...
                            {{-- <li class="nav-item">
                                <a href="#!" class="nav-link">
                                    <svg width="22" height="18" viewBox="0 0 22 18" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M7 1.75C7 0.783509 7.78348 0 8.75 0H19.75C20.7165 0 21.5 0.783509 21.5 1.75V12.75C21.5 13.7165 20.7165 14.5 19.75 14.5H8.75C7.78349 14.5 7 13.7165 7 12.75V1.75ZM8.75 1.5C8.61192 1.5 8.5 1.61192 8.5 1.75V12.75C8.5 12.8881 8.61191 13 8.75 13H19.75C19.8881 13 20 12.8881 20 12.75V1.75C20 1.61192 19.8881 1.5 19.75 1.5H8.75Z"
                                            fill="black" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M3.74129 6.1989C3.87983 6.07101 4.06145 6 4.25 6H7.75C8.16421 6 8.5 6.33579 8.5 6.75V13.75C8.5 14.1642 8.16421 14.5 7.75 14.5H0.75C0.335786 14.5 0 14.1642 0 13.75V9.98075C0 9.77143 0.0874788 9.57163 0.241291 9.42965L3.74129 6.1989ZM4.54323 7.5L1.5 10.3091V13H7V7.5H4.54323Z"
                                            fill="black" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M3.75 14C4.16421 14 4.5 14.3358 4.5 14.75C4.5 15.4403 5.05966 16 5.75 16C6.44034 16 7 15.4403 7 14.75C7 14.3358 7.33579 14 7.75 14C8.16421 14 8.5 14.3358 8.5 14.75C8.5 16.2688 7.26876 17.5 5.75 17.5C4.23124 17.5 3 16.2688 3 14.75C3 14.3358 3.33579 14 3.75 14Z"
                                            fill="black" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M14.75 14C15.1642 14 15.5 14.3358 15.5 14.75C15.5 15.4403 16.0597 16 16.75 16C17.4403 16 18 15.4403 18 14.75C18 14.3358 18.3358 14 18.75 14C19.1642 14 19.5 14.3358 19.5 14.75C19.5 16.2688 18.2688 17.5 16.75 17.5C15.2312 17.5 14 16.2688 14 14.75C14 14.3358 14.3358 14 14.75 14Z"
                                            fill="black" />
                                    </svg>
                            ...
                            <li class="nav-item {{ request()->routeIs(Auth::user()->customer_type.'.shipment.all-invoice') ? 'active' : '' }}">
                                <a href="{{route('private.shipment.all-invoice')}}" class="nav-link">
                                    {{-- <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            @endif
                            <li class="nav-item {{ request()->routeIs(Auth::user()->customer_type.'.chat') ? 'active' : '' }}">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('user-logout') }}" class="nav-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M12 21C16.411 21 20 17.411 20 13C20 9.64999 17.928 6.77899 15 5.58899V7.81199C15.9109 8.33791 16.6676 9.09405 17.1941 10.0046C17.7207 10.9152 17.9986 11.9482 18 13C18 16.309 15.309 19 12 19C8.691 19 6 16.309 6 13C6.00133 11.9481 6.2792 10.9151 6.80575 10.0045C7.3323 9.09396 8.08901 8.33783 9 7.81199V5.58899C6.072 6.77899 4 9.64999 4 13C4 17.411 7.589 21 12 21Z"
                                            fill="black" />
                        ...
                        <ul class="navbar-nav navbar_nav2">
                            <li class="nav-item {{ request()->routeIs('index') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('index') }}">{{ trans('messages.Home') }}</a>
                            </li>
                            <li class="nav-item {{ request()->routeIs('about') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('about') }}"> {{ trans('messages.About Us') }}
                                </a>
                            </li>
                            <li class="nav-item {{ request()->routeIs('service') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ route('service') }}">{{ trans('messages.Services') }}</a>
                            </li>
                            @if (!Auth::user())
                                <li class="nav-item {{ request()->routeIs('truckCcompanyRegistration') ? 'active' : '' }}">
                                    <a class="nav-link"
                                        href="{{ route('truckCcompanyRegistration') }}">{{ trans('messages.Become A Partner') }}</a>
                                </li>
                            @endif
                            <li class="nav-item {{ request()->routeIs('contact') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ route('contact') }}">{{ trans('messages.Contact Us') }}</a>
                            </li>
                        </ul>


                        <div class="extra_nav for_desktop_extra">
                            <ul class="navbar-nav">
                                <li class="nav-item langugae_filter for_desktop">
                                    <a class="nav-link extra_btn dropdown-toggle lang_drop"
                                        href="javascript:void(0);">
                                        <span class="flag_ico">
                                            <img src="{{ config('constants.LANGUAGE_IMAGE_PATH') . $image }}">
                                        </span> {{ strtoupper($select_lang) }} <i class="far fa-chevron-down"></i>
                                    </a>
                                        ...
                                        @if (!empty($languageslist))
                                            @foreach ($languageslist as $item)
                                                <div class="lang_country" id="{{ $item->id }}">
                                                    <a class="nav-link extra_btn dropdown-toggle lang_drop"
                                                        href="{{ route('lang.switch', $item->lang_code) }}"
                                                        data-code="{{ $item->lang_code }}" style="color: black">
                                                        <span class="flag_ico">
                                                            <img src="{{ config('constants.LANGUAGE_IMAGE_PATH') . $item->image }}">
                                                        </span> {{ $item->title }}
                                                    </a>
                                                </div>
                                            @endforeach
                                    ...
                                    <li class="nav-item">
                                        <div class="nav-item dropdown user_dropdown">
                                            <a class="nav-link dropdown-toggle" href="javascript:void(0);"
                                                id="user-drop" role="button" data-bs-toggle="dropdown"
                                                aria-haspopup="true" aria-expanded="false">
                                                <h4>
                                                    <span>{{ trans('messages.Login as') }}:</span> {{ trans("messages.$type") }}
                                                </h4>
                                                    <img src="{{getUserProfileImage(Auth::user()->id)}}" alt="">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="{{ route('user-logout') }}"><i
                                                                    class="ion-log-out"></i>{{ trans('messages.Logout') }}
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                ...
                                @auth
                                    ...
                                    {{-- <li class="nav-item chatAlertIcon_box">
                                        <a href="#!"><svg width="21" height="22" viewBox="0 0 21 22" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <span class="chatAlertIcon @if ($chatCount > 0) show @endif" ></span>
                                    ...
                                    @if (Auth::user()->customer_type == 'business')
                                        <li class="nav-item chatAlertIcon_box">
                                            <a href="{{ route('business.chat') }}"><svg width="21" height="22"
                                                    viewBox="0 0 21 22" fill="currentColor"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M5.02344 7.04649C5.02344 6.62265 5.35141 6.27905 5.756 6.27905H14.5467C14.9513 6.27905 15.2793 6.62265 15.2793 7.04649C15.2793 7.47034 14.9513 7.81394 14.5467 7.81394H5.756C5.35141 7.81394 5.02344 7.47034 5.02344 7.04649Z" />
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M5.02344 11.1395C5.02344 10.7157 5.35141 10.3721 5.756 10.3721H14.5467C14.9513 10.3721 15.2793 10.7157 15.2793 11.1395C15.2793 11.5634 14.9513 11.907 14.5467 11.907H5.756C5.35141 11.907 5.02344 11.5634 5.02344 11.1395Z" />
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M5.02344 15.2327C5.02344 14.8088 5.35141 14.4652 5.756 14.4652H10.6397C11.0443 14.4652 11.3723 14.8088 11.3723 15.2327C11.3723 15.6565 11.0443 16.0001 10.6397 16.0001H5.756C5.35141 16.0001 5.02344 15.6565 5.02344 15.2327Z" />
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M10.5 1.53488C5.51017 1.53488 1.46512 5.77256 1.46512 11V20.4651H10.5C15.4898 20.4651 19.5349 16.2274 19.5349 11C19.5349 5.77256 15.4898 1.53488 10.5 1.53488ZM0.732558 21.2326L0 21.2325V11C0 4.92487 4.70101 0 10.5 0C16.299 0 21 4.92487 21 11C21 17.0751 16.299 22 10.5 22H0.732637L0.732558 21.2326ZM0.732558 21.2326L0.732637 22C0.328056 22 0 21.6563 0 21.2325L0.732558 21.2326Z" />
                                                </svg>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <a href="{{ route('business.notification-list') }}"
                                    ...
                                    @else
                                        <li class="nav-item chatAlertIcon_box">
                                            <a href="{{ route('private.chat') }}"><svg width="21" height="22"
                                                    viewBox="0 0 21 22" fill="currentColor"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M5.02344 7.04649C5.02344 6.62265 5.35141 6.27905 5.756 6.27905H14.5467C14.9513 6.27905 15.2793 6.62265 15.2793 7.04649C15.2793 7.47034 14.9513 7.81394 14.5467 7.81394H5.756C5.35141 7.81394 5.02344 7.47034 5.02344 7.04649Z" />
                                                ...
                                                <span
                                                    class="chatAlertIcon @if ($chatCount > 0) show @endif"></span>
                    ...
                    <div class="extra_nav for_mobile">
                        <ul class="navbar-nav ms-auto">
                            ...
                            @auth
                                <li class="nav-item">
                                    <a href="{{ route('private.chat') }}"><svg width="21" height="22" viewBox="0 0 21 22"
...
@if (Auth::user()->id)
    ...
    @endphp
    <script>
        var socket = io.connect("https://ns.tovilli.co.il", {
            'transports': ['websocket']
        });
        if ('{{ Auth::user()->id }}') {
            socket.on('connect', function() {
                let userId = "user_" + {{ $auth }};
