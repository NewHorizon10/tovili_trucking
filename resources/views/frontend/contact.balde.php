        ...
        <div class="swiper hero-swiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <figure>
                        <img src="{{asset('public/frontend/img/slider-1.png')}}" alt="">
                    </figure>
                    <div class="hero-content">
                        <div class="container">
                           
                            <h1 class="banner-title">CARGO TRANSPORT</h1> 
                            <h1 class="banner-title2">Fast and Secure Services</h1>
                            <h3 class="banner-title3">Cost efficient & always on time,<br>
                                that’s our transport company moto!</h3>
                                <a href="#!" class="secondary-btn support-btn">Get Support <svg width="28" height="26" viewBox="0 0 28 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="swiper-slide">
                    <figure>
                        <img src="{{asset('public/frontend/img/slider-2.jpg')}}" alt="">
                    </figure>
                    <div class="hero-content">
                        <div class="container">
                            <h1 class="banner-title">CARGO TRANSPORT</h1>
