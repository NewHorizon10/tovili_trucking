...
Route::middleware(['AuthFront'])->group(function () {
    ...
    Route::get('clear-all-notification', [App\Http\Controllers\frontend\CustomerController::class, 'clearAllNotification'])->name('clear-all-notification');
...
// Route::get('when_digital_and_no_certificate_uploaded', [App\Http\Controllers\frontend\TruckCompanyController::class, 'when_digital_and_no_certificate_uploaded']);