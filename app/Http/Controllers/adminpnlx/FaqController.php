...
class FaqController extends Controller
{
    ...
    public function store(Request $request){
        ...
        if ($validator->fails()) {
            ...
            Session()->flash('success', ucfirst(trans("messages.admin_FAQ_has_been_added_successfully")));
    ...
    public function update(Request $request, $enfaqid){
        ...
        if ($validator->fails()) {
            ...
            Session()->flash('success', ucfirst(trans("messages.admin_FAQ_has_been_updated_successfully")));
            return Redirect()->route($this->model . ".index");
        }
    }
    ...
    public function destroy($enfaqid){
        ...
        Session()->flash('flash_notice', ucfirst(trans("messages.admin_FAQ_has_been_removed_successfully")));
        return back();
    }
}
