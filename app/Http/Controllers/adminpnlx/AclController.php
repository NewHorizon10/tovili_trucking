...
class AclController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		$obj                =  new Acl;
		$obj->parent_id     =   !empty($request->input('parent_id')) ? $request->input('parent_id') : null;
	...
	public function menu_update(Request $request,$encmsid){
        ...
        if (!empty($encmsid)) {
            ...
            if ($validator->fails()) {
                ...
                Session()->flash('success', trans("messages.menu_setting_has_been_updated_successfully"));
                return Redirect()->route("menu_setting.index");
            }
